...
# does not work with files that have wildcards...!
...
log "running gsutil ls -r ${bucket_path} | grep gs:// > ${temp_file}" "info" "console"
gsutil ls -lr ${bucket_path} | grep "gs://" > ${temp_file}
...
for i in `cat ${temp_file} | awk '{print $3}'` ; do
